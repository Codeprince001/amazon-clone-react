...
const Home = () => {
  return (
    <div className='relative'>
      ...
      <section className='grid gap-5 m-4 grid-cols-3 xl:grid-cols-4 mb-6 cursor-pointer'>
        <div><Product title=" EMERGENCY FIRE BLANKET" description="Prepared Hero Emergency Fire Blanket - 4 Pack - Fire Suppression Blanket for Kitchen, 40” x 40” Fire Blanket for Home, Fiberglass Fire Blanket" imgUrl="https://m.media-amazon.com/images/I/91pRqzzKSwL.__AC_SY300_SX300_QL70_FMwebp_.jpg" price={20} rating={4} /></div>
        <div><Product title=" HotHands Hand Warmer" description="HotHands Hand Warmer Value Pack( 10 count)" imgUrl="https://m.media-amazon.com/images/I/610GhgA90CL.__AC_SX300_SY300_QL70_FMwebp_.jpg" price={6} rating={3} /></div>
        <div><Product title="Sceptre 24-inch" description="Sceptre 24-inch Professional Thin 1080p LED Monitor 99% sRGB 2x HDMI VGA Build-in Speakers, Machine Black (E248W-19203R Series) Professional Thin 1080p LED Monitor 99% sRGB 2x HDMI VGA Build-in Speakers, Machine Black (E248W-19203R Series)" imgUrl="https://m.media-amazon.com/images/I/81zM2vVM+wL._AC_SX679_.jpg" price={89} rating={4} /></div>
        <div><Product title=" Queen Womens Flannel Jacket" description="Trendy Queen Womens Flannel Shacket Jacket Casual Plaid Wool Blend Button Down Long Sleeve Shirt Fall Clothes Outfits 2023" imgUrl="https://m.media-amazon.com/images/I/61MQqc51uOL._AC_SY445_.jpg" price={28} rating={4} /></div>
      </section>
    </div >
  );
};
